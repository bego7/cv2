...
/*Funcion animado barra de habilidades*/
...
jQuery('.pie').each(function(index, element) {
  var num = +($(this).text());
  var chart = '<svg viewBox="0 0 32 32"><circle class="circle" r="16" cx="16" cy="16" style="stroke-dasharray: 10 100, display:inline"/></svg>';
